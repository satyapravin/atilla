...
namespace Bitmex.NET
{
    public static partial class BitmexApiUrls
    {
        ...
        public static partial class Order
        {
            ...
            /// Get your orders
            /// </summary>
            public static ApiActionAttributes<OrderGETRequestParams, List<OrderDto>> GetPosition = new ApiActionAttributes<OrderGETRequestParams, List<OrderDto>>("order", HttpMethods.GET);
            /// <summary>
